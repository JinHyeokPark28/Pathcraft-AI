...
**DoD:**
- [ ] WPF OpenFileDialog 구현
- [ ] .xml 파일 파싱 (기존 parser 재사용)
- [ ] 분석 결과 UI 표시
- [ ] 파일 크기 제한 (10MB)
- [ ] 잘못된 파일 에러 처리
...
**DoD:**
- [ ] WPF 필터 UI (ComboBox, CheckBox)
- [ ] Python 백엔드 필터 파라미터 추가
- [ ] YouTube API 쿼리 수정
- [ ] 결과 정렬 로직
...
**다음 Sprint 후보 (Top 3):**
1. POB 파일 업로드 (Phase 8 필수)
2. 검색 필터 (Phase 8 권장)
3. 빌드 북마크 시스템 (Phase 8 선택)
