...
#### Tier 2: AI Analysis (AI 분석)
**타겟:** 빌드 분석을 원하는 중급 이상 사용자

**기능:**
- ✅ **사용자 API 키 사용** (GPT/Gemini/Claude)
- ✅ AI 빌드 분석
  - 빌드 개요 (컨셉, 플레이스타일)
  - 장점/단점 (3-4개 bullet points)
  - 추천 대상 (예산, 난이도)
  - 핵심 시너지 (아이템/젬/패시브 상호작용)
- ✅ AI 모델 선택 (드롭다운)
- ✅ 분석 결과 저장 (로컬)
- ✅ 3일 무료 체험 (API 키 입력 후)
- ⚠️ 광고 표시
...
**사용 예시:**
```
1. 설정에서 OpenAI API 키 입력
2. POB 링크 클릭 → "AI 분석" 버튼
3. GPT-4o가 빌드 분석 (2-3초)
4. 결과:
   - "카오스 지속 피해 빌드"
   - 장점: 매핑 속도, 생존력
   - 단점: 보스 DPS 낮음
